...
<html lang="en">
  ...
  <body>
    <div class="container-fluid">
        <form class="mx-auto" method="post" action="{{ route('post_login') }}">
          @csrf
            ...
            <p class="text-desc text-muted mt-5 mb-0">Don't have any account?<a href="{{ route('register') }}"
              class="fw-bold text-desc"><u> Sign up</u></a></p>
          </form>
    </div>
